$(document).ready(function() {
  ...
  var sideS, sidebar = {
    ...
    toggleMenu: function(dir) {
      ...
      var animOut = new TimelineLite({
        paused: true
      });
      var animIn = new TimelineLite({
        paused: true
      });
      ...
      if (!rtlDirectionFlag) {
        animOut
          ...
          .to(sideS.$main, timing, {
            left: 0,
            right: 0,
            ease: Power4.ease
          }, 'start')
          .to(sideS.$exteras, timing, {
            marginRight: 0,
            ease: Power4.easeOut
          }, 'start');
...
function submitContact() {
  ...
  contactForm.submit(function(e) {
    ...
    //Showing alert popup
    var showAlert = new TimelineLite({
      paused: true
    });
    hideAlert = new TimelineLite({
      paused: true
    });
    showAlert.to(alertWrapper, 0.3, {
      opacity: 1,
      top: '30%'
    });
